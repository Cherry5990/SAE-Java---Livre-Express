...
public class MenuVendeur {
    ...
    public static void connexionVendeur(ConnexionMySQL con){
        ...
        System.out.println("Êtes vous bien " + MenuVendeur.vendeur.getPrenom() + " " + MenuVendeur.vendeur.getNom()+"?");
    ...
    public static void menuVendeur(ConnexionMySQL con){
        ...
        System.out.println("│ 1 - Ajouter un livre au stock            │");
        ...
        System.out.println("│ 5 - Transférer un livre                  │");
    ...
    public static void sousMenuPasserUneCommande(ConnexionMySQL con){
        ...
        switch (action) {
            ...
            case "q":
                System.out.println("┌───────────────────────────────────────────────┐");
                System.out.println("│ Attention cela va supprimer la commmande      │");
        ...
        switch (action){
            ...
            default:
                try {
                    ...
                    if (livre == null){
                        System.out.println("Navré, mais "+vendeur.getMagasin().getNomMagasin()+" n'a pas le livre que vous souhaitez");
                        ...
                        switch (verif) {
                            case "c":
                                ...
                                if (qteInt <= stock && qteInt>0) {
                                    ...
                                    System.out.println("Livre ajouté à la commande avec succés");
                                }
                                else{
    ...
    public static void sousMenuValiderLaCommande(ConnexionMySQL con){
        System.out.println("┌──────────────────────────────────────────────────────────────┐");
        System.out.println("│ Êtes vous sûr de vouloir valider votre commande ?            │");
        ...
        switch (action2) {
            case "c":
                ...
                System.out.println("┌────────────────────────────────────────────────────────────────┐");
                System.out.println("│           Très bien, la commande est enregistrée               │");
                System.out.println("└────────────────────────────────────────────────────────────────┘");
    ...
    public static void sousMenuAjouterLivre(ConnexionMySQL con){
        ...
        System.out.println("│ Rentrez le nom du livre que vous souhaitez ajouter │");
        System.out.println("│ Q - Revenir en arrière                             │");
        System.out.println("└────────────────────────────────────────────────────┘");
    ...
    public static void procedureDAjout(ConnexionMySQL con, String entrer){
        try {
            ...
            if(isbnExiste){
                System.out.println("Le livre existant déjà dans le réseau, les information de celui-ci sont déjà renseignées");
    ...
    public static void demandeNbLigneEtPrix(ConnexionMySQL con, String nom, String isbn){
        System.out.println("Le livre n'existant pas dans le réseau, vous allez devoir renseigner ces informations");
        ...
        switch (entrer) {
            ...
            case "c":
                ...
                System.out.println("Rentrer uniquement des chiffres ou un point pour les virgules");
                System.out.println("Vous retournerez au menu d'ajout si vous faite une erreur");
                System.out.println("──────────────────────────────────────────────────────────────");
    ...
    public static void sousMenuMajQte(ConnexionMySQL con){
        System.out.println("┌────────────────────────────────────────────────────┐"); 
        System.out.println("│ Vous êtes sur la page de mise à jour de quantité   │");
    ...
    public static void MajQteDonnerIsbn(ConnexionMySQL con){
        ...
        try {
            ...
            System.out.println("Veuillez à bien rentrer 13 chiffres sans espaces");
            MenuVendeur.MajQteDonnerIsbn(con);
        } catch(Exception e){
                System.out.println("Veuillez rentrer un nombre");
                MenuVendeur.MajQteDonnerIsbn(con);
    ...
    public static void MajQteDonnerValider(ConnexionMySQL con, String titre, Integer qte, String isbn){
        System.out.println("───────────────────────────────────────────────────────"); 
        System.out.println("Confirmez vous la mise à jour de la quantité de : "); 
        ...
        switch (entrer) {
            ...
            case "c":
                ...
                System.out.println("Appuyez sur entrer pour retourner au menu mise à jour de quantité");
                System.out.println("──────────────────────────────────────────────────────────────────────────────────");
                String saut = scan.nextLine().trim();
                MenuVendeur.sousMenuMajQte(con);
            default:
    ...
    public static void sousMenuVerifDispo(ConnexionMySQL con){
        ...
        System.out.println("│ Rentrez le nom du livre que vous souhaitez vérifier    │");
    ...
    public static void sousMenuTransfererLivre(ConnexionMySQL con){
        System.out.println("┌───────────────────────────────────────────────────────────────┐");        
        System.out.println("│ Vous êtes sur la page de transferts de livre                  │");
    ...
    public static void transfererLivreDemandeIdMag(ConnexionMySQL con, String isbn, String titre){
        try {
            ...
            System.out.println("┌───────────────────────────────────────────────────────────────┐");
            System.out.println("│Rentrez l'id du magasin duquel vous voulez transférer le livre │"); 
            System.out.println("│Rentrez uniquement un nombre                                   │"); 
    ...
    public static void transfererLivreDemandeQte(ConnexionMySQL con, Integer idmag, String isbn, String titre){
        try {
            System.out.println("┌────────────────────────────────────────────────────────┐"); 
            System.out.println("│Rentrez la quantité de livre que vous voulez transférer │"); 
            System.out.println("│[R] Faire une nouvelle recherche [Q] Retour en arriere  │");
            System.out.println("│[M] Menu Vendeur                                        │");
            System.out.println("└────────────────────────────────────────────────────────┘");
            ...
            switch(entrerQte){
                ...
                default:
                    ...
                    System.out.println("┌─────────────────────────────────────────────┐"); 
                    System.out.println("│Le transfert s'est effectué sans problèmes   │"); 
                    System.out.println("└─────────────────────────────────────────────┘");
                    String action = scan.nextLine().toLowerCase().trim();
                    MenuVendeur.sousMenuTransfererLivre(con);
