...
public class PageVendeurTransfererLivre {
    private Scene scene;
    ...
    public PageVendeurTransfererLivre(App app)throws IOException{
        Pane root = FXMLLoader.load(getClass().getResource("../view/Vendeur/PageVendeurTransfererLivre.fxml"));
        ...
        for(Magasin mag : App.magasinBD.getAllMagasins()){
            if(mag.getIdMagasin() != App.vendeur.getMagasin().getIdMagasin()){
                this.comboMag.getItems().add(mag.getNomMagasin());
            }
                
        }
        for(Magasin mag : App.magasinBD.getAllMagasins()){
            if(mag.getNomMagasin().equals(this.comboMag.getValue())) {
        ...
        // Ajout d'un listener pour comboMag afin de gérer la sélection du magasin
        ...
        transferer.setOnAction(new ControleurVendeurTransferer(app,this));
    ...
    public void reset(){
        ...
        this.comboMag.getSelectionModel().clearSelection();
        this.comboMag.setPromptText(("Selectionner un magasin"));
    ...
    public void modifValeurs(){
        try {
            ...
            qte.setText(String.valueOf(App.magasinBD.getQte(livre.getIsbn(), this.idMagasin)));
